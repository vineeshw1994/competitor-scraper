...
async function upsertCompetition(row) {
  ...
  const sql = `
    ...
    ON DUPLICATE KEY UPDATE
      ...
      type = VALUES(type),
      ticket_price = COALESCE(VALUES(ticket_price), ticket_price),
      total_tickets = COALESCE(VALUES(total_tickets), total_tickets),
      tickets_sold = COALESCE(VALUES(tickets_sold), tickets_sold),
      tickets_remaining = COALESCE(VALUES(tickets_remaining), tickets_remaining),
      pct_sold = VALUES(pct_sold),
      days_running = COALESCE(VALUES(days_running), days_running),
      daily_sellthrough = VALUES(daily_sellthrough),
      total_ticket_revenue = COALESCE(VALUES(total_ticket_revenue), total_ticket_revenue),
      jackpot_prize = COALESCE(VALUES(jackpot_prize), jackpot_prize),
      jackpot_value = COALESCE(VALUES(jackpot_value), jackpot_value),
      draw_date = COALESCE(VALUES(draw_date), draw_date),
      status = VALUES(status),
      game_type = COALESCE(VALUES(game_type), game_type),
      confidence_tier = COALESCE(VALUES(confidence_tier), confidence_tier),
      sell_speed = COALESCE(VALUES(sell_speed), sell_speed),
      iw_prizes = COALESCE(VALUES(iw_prizes), iw_prizes),
      iw_total_count = COALESCE(VALUES(iw_total_count), iw_total_count),
      iw_total_value = COALESCE(VALUES(iw_total_value), iw_total_value),
      total_prize_cost = COALESCE(VALUES(total_prize_cost), total_prize_cost),
      iw_density_pct = COALESCE(VALUES(iw_density_pct), iw_density_pct),
      iw_value_pct = COALESCE(VALUES(iw_value_pct), iw_value_pct),
      operator_revenue_at_sellout = COALESCE(VALUES(operator_revenue_at_sellout), operator_revenue_at_sellout),
      last_scraped_at = NOW()
  `;
